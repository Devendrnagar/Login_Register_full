...
// 
// const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://login-register-full-1.onrender.com/api';

const API_BASE_URL = 'https://login-register-full-1.onrender.com/api';
